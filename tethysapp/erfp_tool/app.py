...
class ECMWFRAPIDFloodPredictionTool(TethysAppBase):
    ...
    def url_maps(self):
        ...
        url_maps = (UrlMap(name='home',
                    ...
                    UrlMap(name='add-watershed-prediction-files-ajax',
                           url='erfp-tool/add-watershed/download_predictions',
                           controller='erfp_tool.controllers_ajax.watershed_download_predicitons'),
                    ...
                    UrlMap(name='manage-watershed-ecmwf-rapid-files-ajax',
                           ...
                           controller='erfp_tool.controllers_ajax.watershed_ecmwf_rapid_file_upload'),
                    UrlMap(name='manage-watershed-prediction-files-ajax',
                           url='erfp-tool/manage-watersheds/download_predictions',
                           controller='erfp_tool.controllers_ajax.watershed_download_predicitons'),
