    ...
    $(function() {
        ...
        $('#submit-add-watershed').click(function(){
            ...
            if(geoserver_id==1){
                ...
                geoserver_outline_layer = $('#geoserver-outline-input').val(); //TODO make this required
                                ...
                                jQuery.when(xhr_catchment).done(function(catchment_data){
                                    ...
                                    jQuery.when(xhr_gage).done(function(gage_data){
                                        ...
                                        if(outline_shp_files.length >= 4){
                                            ...
                                            xhr_outline = ajax_update_database_multiple_files("update",data,
